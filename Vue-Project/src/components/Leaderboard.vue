  ...
  <div class="all">
    ...
    <el-table-column type="expand">
      <template slot-scope="props">
        <el-container>
          <el-aside><div>ASIDE</div></el-aside>
          <el-main>
            <el-row>
              <el-row>
                <el-col :span="4"><div class=""><el-button type="text">{{language.task_sjnl}}</el-button></div></el-col>
                <el-col :span="4"><div class=""><el-button type="text">{{language.task_ljnl}}</el-button></div></el-col>
                <el-col :span="4"><div class=""><el-button type="text">{{language.task_jsnl}}</el-button></div></el-col>
                <el-col :span="4"><div class=""><el-button type="text">{{language.task_szjsnl}}</el-button></div></el-col>
                <el-col :span="4"><div class=""><el-button type="text">{{language.task_scnl}}</el-button></div></el-col>
                <el-col :span="4"><div class=""><el-button type="text">{{language.task_dyynl}}</el-button></div></el-col>
              </el-row>
            </el-row>
            <hr>
            <el-row>
              <el-row>
                <el-col v-for="(i,index) in taskData" :key="index" :span="Math.floor(24/taskData.length)"><div class=""><el-button type="text">{{i.name}}</el-button></div></el-col>
              </el-row>
              <hr>
              <el-row>
                <el-col v-for="(i,index) in taskData" :key="index" :span="Math.floor(24/taskData.length)"><div class="">{{i.score}}</div></el-col>
              </el-row>
              <hr>
            </el-row>
            <el-row>
              <el-row>
                <el-col v-for="(i,index) in dataData" :key="index" :span="Math.floor(24/dataData.length)"><div class=""><el-button type="text">{{i.name}}</el-button></div></el-col>
              </el-row>
              <hr>
              <el-row>
                <el-col v-for="(i,index) in dataData" :key="index" :span="Math.floor(24/dataData.length)"><div class="">{{i.score}}</div></el-col>
              </el-row>
              <hr>
            </el-row>
          </el-main>
