      ...
      if (res.status === 200) {
        ...
        for (var i = 0; i < t.length; i++) {
          ...
          var toAppend = {
            ...
            // score: r.智源指数[0],
            sxtl: r.数学推理能力[0] + '(' + r.数学推理能力[1] + ')',
            dyy: r.多语言能力[0] + '(' + r.多语言能力[1] + ')',
            dhjh: r.对话交互能力[0] + '(' + r.对话交互能力[1] + ')',
            yysc: r.语言生成能力[0] + '(' + r.语言生成能力[1] + ')',
            xxhq: r.信息获取及问答能力[0] + '(' + r.信息获取及问答能力[1] + ')',
            yyljpj: r['语言理解能力-篇章级'][0] + '(' + r['语言理解能力-篇章级'][1] + ')',
            yyljcy: r['语言理解能力-词语级'][0] + '(' + r['语言理解能力-词语级'][1] + ')',
